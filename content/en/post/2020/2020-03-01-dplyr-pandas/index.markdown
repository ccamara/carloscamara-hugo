...
But that's not fair, we are comparing countries with very different number of population! If we are to compare them, we need to use relative values. We would need to create a ranking based on the total number of cases per 1000 habitants.
